...
def train(epoch, config, model, dataloaders, criterion, optimizer, scheduler, text_ori):
    # 记录损失
...
def main(args):
    ...
    # TODO: cross 和 target 下模式不同；多增加一个文件 train_target.py
    ...
    if config.train_or_test == 'train':
        ...
        for epoch in range(1, config.epochs + 1):
            ...
            train_output = train(epoch, config, model, dataloaders, criterion, optimizer, scheduler, text_ori)
