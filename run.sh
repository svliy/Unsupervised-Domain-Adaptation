# gft ---> bp4d
# cross: stage 1
CUDA_VISIBLE_DEVICES=1 python train_stage1.py --config_file gft2bp4d_stage1
# cross: stage 2
CUDA_VISIBLE_DEVICES=6 python train_stage2.py --config_file gft2bp4d_stage2
# pseudo label
CUDA_VISIBLE_DEVICES=1 python train_stage1_pseudo_label.py --config_file gft2bp4d_stage1
...
# bp4d ---> gft
## cross: stage 1
CUDA_VISIBLE_DEVICES=3 python train_stage1.py --config_file bp4d2gft_stage1
## cross: stage 2
CUDA_VISIBLE_DEVICES=3 python train_stage2.py --config_file bp4d2gft_stage2
## target
CUDA_VISIBLE_DEVICES=1 python train_target.py --config_file bp4d2gft_stage1


# disfa ---> bp4d 
CUDA_VISIBLE_DEVICES=4 python train_stage1.py --config_file disfa2bp4d_stage1
# bp4d ---> disfa 
CUDA_VISIBLE_DEVICES=2 python train_stage1.py --config_file bp4d2disfa_stage1

# single domain
CUDA_VISIBLE_DEVICES=0 python train_target.py --config_file bp4d
...
# bp4d ---> disfa
CUDA_VISIBLE_DEVICES=5 python train_stage1.py --config_file bp4d2disfa_stage1
# disfa ---> bp4d
